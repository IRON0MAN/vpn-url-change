...
export const translations = {
  'zh-CN': {
    ...
    nodeNamePrefix: '节点名前缀',
    nodeNamePrefixPlaceholder: '例如：VIP-',
  ...
  'en-US': {
    ...
    nodeNamePrefixPlaceholder: 'e.g., VIP-',
  ...
  'fa': {
    ...
    nodeNamePrefix: 'پیشوند نام نود',
    nodeNamePrefixPlaceholder: 'مثال: VIP-',
  ...
  'ru': {
    ...
    nodeNamePrefix: 'Префикс имени узла',
    nodeNamePrefixPlaceholder: 'Например: VIP-',
